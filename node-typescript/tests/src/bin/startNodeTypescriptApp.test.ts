  ...
  context('given the app directory does not exist', () => {
    context(`when startNodeTypescriptApp("app") is called`, () => {
      ...
      before(async function () {
        ...
        packageJson = require(resolve(appDirectory, 'package.json')) as Record<string, unknown>;
      });
      ...
      it('should create the .eslintrc.json file', () => {
        const eslintrcTemplate = JSON.parse(getFileContent([root, '.eslintrc.json'])) as Record<string, unknown>;
